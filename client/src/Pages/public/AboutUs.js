...
import about_us_IMG from '../../includes/img/jpeg/AdobeStock_483688558.jpeg';

function AboutUs() {
  return (
    <div className='hero'>    
                <div className='container md:mx-auto bg-slate-400'>
                    <img className='' src={about_us_IMG} alt="our story"></img>
